export default [
  ...
  {
    text: "Konsultacje dla par."
  },
  {
    text:
      "Psychoterapię krótkoterminową - kilka do kilkunastu spotkań, których celem jest pomoc osobom przeżywającym kryzys np. znacząca zmiana sytuacji życiowej, rozwód."
  },
  {
    text:
